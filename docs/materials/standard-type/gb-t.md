...
Material designations in this group follow **GB/T**-related requirements where applicable. The block below is one **blank** public datasheet in the same order: title, metadata, chemical table, mechanical table. Replace placeholders; confirm by inquiry and order.
